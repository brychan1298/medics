		...
		<div class="row" style="margin-top:0px;">
			...
			<div class="col-sm-12">									
				<table  class="table-border table col-lg-12" style="border-bottom: 1px solid #707070;margin: 5px;">
					...
					<?php $__currentLoopData = $ahospital; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							<td><?php echo e($aa->nama); ?></td>
							<td><?php echo e($aa->provinsi); ?></td>
							<td><?php echo e($aa->nohp); ?></td>
							<td><?php echo e($aa->alamat); ?></td>
							<td><?php echo e($aa->kota); ?></td>
							<td><a href="/hospital/edit/<?php echo e($aa->id); ?>" style="background-color: #4385FF; color: white;border:0px;border-radius: 20px;padding: 10px 30px;" >EDIT</a></td>
							<td><a href="/hospital/delete/<?php echo e($aa->id); ?>" style="background-color: #4385FF; color: white;border:0px;border-radius: 20px;padding: 10px 30px;" >DELETE</a></td>
						</tr>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TAmedics\resources\views/admin/admindatahospital.blade.php ENDPATH**/ ?>