  ...
  <div class="container mb-5">
    <div class="slideshow-container">
      <div class="row" style="width:100%;height:300px;background-color:white;margin-top: 150px;">
        ...
        <div class="col-sm-6 col-12 mySlides fade">
          <img class="w-100" src="img/home.png" class="col-sm-12">
        </div>
        <div class="col-sm-6 col-12 mySlides fade">
          <img class="w-100" src="img/ma.jpg" class="col-sm-12">
        </div>
        <div class="col-sm-6 col-12 mySlides fade">
          <img class="w-100" src="img/vector.png" class="col-sm-12">
        </div>
        <div class="col-sm-6 col-12 mySlides fade">
          <img class="w-100" src="img/onepage-estore.png" class="col-sm-12">
        </div>
      </div>
    </div>      
  </div>
    ...
    <div class="container mt-5">
      <div class="row" style="width:100%;height:550px;background-color:white;margin-top: 200px;">
